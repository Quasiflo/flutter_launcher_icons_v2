...
class MockConfig extends _i1.Mock implements _i3.Config {
  ...
  @override
  bool get removeLiquidGlassIOS => (super.noSuchMethod(
        Invocation.getter(#removeLiquidGlassIOS),
        returnValue: false,
      ) as bool);
  ...
  @override
  double get liquidGlassIconScaleIOS => (super.noSuchMethod(
        Invocation.getter(#liquidGlassIconScaleIOS),
        returnValue: 0.0,
      ) as double);

  @override
  bool get liquidGlassSpecularIOS => (super.noSuchMethod(
        Invocation.getter(#liquidGlassSpecularIOS),
        returnValue: false,
      ) as bool);

  @override
  String get liquidGlassShadowKindIOS => (super.noSuchMethod(
        Invocation.getter(#liquidGlassShadowKindIOS),
        returnValue: _i4.dummyValue<String>(
          this,
          Invocation.getter(#liquidGlassShadowKindIOS),
        ),
