...
// iOS used to bypass the shared loader with a direct
// `decodeImage(File().readAsBytes())`, silently returning on undecodable
// images. It now routes through `decodeImageFile`, so bad inputs throw.
void main() {
