...
// universal set plus the single-size variant. These lock the entry counts,
// the shared-1024 dual reference, and the dark/tinted marketing exclusion
// so future edits cannot silently drift the schema.
void main() {
